export const features = [
  {
    ...
    title: "Smarter Picks, Better Flicks",
    text: "Say goodbye to endless scrolling. PopcornPicks learns your taste and serves up movie magic made just for you — quick, easy, and surprisingly spot-on.",
    button: {
  ...
  },
  {
    ...
    caption: "Weekly Favorites",
    title: "Watch the Best, With the Best",
    text: "From must-see thrillers to feel-good favorites — we spotlight the hottest movies of the week. Grab your snacks, call your crew, and make movie night unforgettable.",
    button: {
...
export const details = [
  {
    ...
    title: "Smart AI Movie Recommendations",
  },
  {
    id: "1",
  ...
  },
  {
    ...
    title: "Instant Trailer Previews",
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
    title: "Explore Trending Picks 24/7",
  },
];
export const faq = [
  {
    id: "0",
    question: "How does PopcornPicks recommend movies for me?",
    answer:
      "PopcornPicks uses your favorite movies, selected genres, story preferences, and even the people you're watching with to create smart, personalized movie suggestions you'll love.",
  },
  {
    id: "1",
    question: "Can I create a watchlist on PopcornPicks?",
    answer:
      "Yes! You can easily build and manage your own watchlist, which helps PopcornPicks learn your style and make better recommendations tailored just for you.",
  },
  {
    id: "2",
    question: "How often is your movie database updated?",
    answer:
      "We update our database weekly with the latest releases, hidden gems, and timeless classics — so you’ll always have fresh picks waiting for you.",
  },
  {
    id: "3",
    question: "Can I filter suggestions by mood or who I’m watching with?",
    answer:
      "Absolutely! You can pick whether you're watching alone, with friends, on a date night, or with family, and PopcornPicks will adjust its suggestions to match the vibe.",
  },
  {
    id: "4",
    question: "Do I need an account to get movie suggestions?",
    answer:
      "Nope — you can start getting recommendations right away. But creating a free account lets you save your favorites, build watchlists, and get more personalized results.",
  },
  {
    id: "5",
    question: "Can I suggest movies to add to PopcornPicks?",
    answer:
      "Yes! We love hearing from our users. You can submit your favorite underrated picks through our 'Suggest a Movie' feature and we’ll review them for our database.",
  },
  {
    id: "6",
    question: "Is PopcornPicks free to use?",
    answer:
      "100%! PopcornPicks is completely free for everyone to use — no subscriptions, no hidden fees, just great movie recommendations whenever you need them.",
  },
  {
    id: "7",
    question: "How does PopcornPicks handle different genres I like?",
    answer:
      "When you select multiple favorite genres, PopcornPicks blends them together and suggests movies that match those combined styles, giving you unique and diverse options.",
  },
  {
    id: "8",
    question: "What if I don’t like the recommendations?",
    answer:
      "No worries! You can easily update your favorites, genres, or mood anytime to refresh your picks. The more you use PopcornPicks, the smarter it gets.",
  },
  {
    id: "9",
    question: "Can I share my movie picks with friends?",
    answer:
      "Of course! Every watchlist and recommendation can be shared with friends, so you can easily plan movie nights and share your latest discoveries.",
  },
];
export const plans = [
  {
    ...
    priceMonthly: 19,
    priceYearly: 12,
    caption: "Great for casual movie lovers",
    features: [
      "500 movie recommendations",
      "Basic watchlist creation",
      "Limited AI-powered suggestions",
      "Access to public movie lists",
    ],
  ...
  },
  {
    ...
    priceMonthly: 79,
    priceYearly: 59,
    caption: "Popular choice for cinephiles",
    features: [
      "All Core features",
      "Unlimited movie recommendations",
      "Advanced AI-based picks",
      "Create & share custom watchlists",
      "Community favorites & trending lists",
    ],
  ...
  },
  {
    ...
    priceMonthly: 39,
    priceYearly: 29,
    caption: "Ideal for friends, teams, and creators",
    features: [
      "All Overdrive features",
      "Collaborative watchlists",
      "Group movie night planning",
...
export const testimonials = [
  {
    ...
    comment:
      "PopcornPicks totally nailed my movie taste. I’ve found so many hidden gems I would’ve never stumbled upon on my own!",
  },
  {
    id: "1",
    name: "Mark Erixon",
    ...
    comment:
      "This site gets me. I tell it what kind of vibe I'm after, and it recommends the perfect movie — every single time.",
  },
  {
    id: "2",
    name: "Melanie Hurst",
    role: "Rom-Com Enthusiast",
    avatarUrl: "/images/testimonials/melanie-hurst.png",
    comment:
      "I love how PopcornPicks curates movies based on who I'm watching with. It makes date nights so much easier!",
  },
  {
    id: "3",
    name: "Alicia Barker",
    role: "Film Critic & Blogger",
    avatarUrl: "/images/testimonials/alicia-barker.png",
    comment:
      "I’ve discovered such unique films through PopcornPicks — it’s like having a movie-savvy friend in my pocket.",
  },
  {
    id: "4",
    name: "Becky Snider",
    role: "Family Night Organizer",
    avatarUrl: "/images/testimonials/becky-snider.png",
    comment:
      "Picking a movie for the whole family used to be a struggle. Now PopcornPicks makes it fun and surprisingly easy.",
  },
  {
    id: "5",
    name: "Jim Bradley",
    role: "Indie Movie Fanatic",
    avatarUrl: "/images/testimonials/jim-bradley.png",
    comment:
      "PopcornPicks has introduced me to incredible indie films I'd never find anywhere else. It’s my new favorite thing.",
  },
];
